...
namespace BankingApp.Controllers
{
    public class PersonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,IdNumber")] Persons persons)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,IdNumber")] Persons persons)
        {
            if (id != persons.Id)
            {
                return NotFound();
